...
[![contributions welcome](https://img.shields.io/badge/contributions-welcome-brightgreen?logo=github)](CODE_OF_CONDUCT.md) [![Website](https://img.shields.io/website?url=https%3A%2F%2Fhoppscotch.io&logo=hoppscotch)](https://hoppscotch.io) [![Tests](https://github.com/Nabeelshar/postman-api/actions/workflows/tests.yml/badge.svg)](https://github.com/Nabeelshar/postman-api/actions) [![Tweet](https://img.shields.io/twitter/url?url=https%3A%2F%2Fhoppscotch.io%2F)](https://twitter.com/share?text=%F0%9F%91%BD%20Hoppscotch%20%E2%80%A2%20Open%20source%20API%20development%20ecosystem%20-%20Helps%20you%20create%20requests%20faster,%20saving%20precious%20time%20on%20development.&url=https://hoppscotch.io&hashtags=hoppscotch&via=hoppscotch_io)

  </p>
  <p>
    <sub>
      Built with ❤︎ by
      <a href="https://github.com/Nabeelshar/postman-api/graphs/contributors">
        contributors
      </a>
    </sub>
  </p>
...
- **[Browser Extensions](https://github.com/Nabeelshar/postman-api-extension)** - Browser extensions that simplifies access to Hoppscotch
...
0. Update [`.env.example`](https://github.com/Nabeelshar/postman-api/blob/main/.env.example) file found in the root of repository with your own keys and rename it to `.env`.
...
- [Gitpod](https://gitpod.io/#https://github.com/Nabeelshar/postman-api)
...
2. Install pnpm using npm by running `npm install -g pnpm`.
3. Install dependencies by running `pnpm install` within the directory that you cloned (probably `hoppscotch`).
4. Update [`.env.example`](https://github.com/Nabeelshar/postman-api/blob/main/.env.example) file found in the root of repository with your own keys and rename it to `.env`.
...
Please contribute using [GitHub Flow](https://guides.github.com/introduction/flow). Create a branch, add commits, and [open a pull request](https://github.com/Nabeelshar/postman-api/compare).

Please read [`CONTRIBUTING`](CONTRIBUTING.md) for details on our [`CODE OF CONDUCT`](CODE_OF_CONDUCT.md), and the process for submitting pull requests to us.

## **Continuous Integration**

We use [GitHub Actions](https://github.com/features/actions) for continuous integration. Check out our [build workflows](https://github.com/Nabeelshar/postman-api/actions).
